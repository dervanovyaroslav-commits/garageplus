...
export const PromotionCarousel = () => {
  ...
  const promotions = [
    ...
    },
    {
      ...
      description: 'При покупке моторного масла и масляного фильтра ДВС в период с 01.12.2025 по 31.03.2026 работа по замене масла и масляного фильтра ДВС — В ПОДАРОК!!!',
      price: 'В ПОДАРОК!!!',
      originalPrice: '1 500 ₽',
      deadline: '(*Если для замены масла необходимо снимать защиту ДВС — работа по снятию защиты — оплачиваются)',
      badge: 'В ПОДАРОК!!!',
      image: '/promotions/oilservice.jpg'
    }
    // {
