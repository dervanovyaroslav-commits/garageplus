...
const MajorOverhaulService = () => {
  const serviceData = {
    title: "Капитальный ремонт двигателя",
    subtitle: "Полный капитальный ремонт двигателя Mercedes-Benz",
    description: "Капитальный ремонт двигателя Mercedes-Benz W222 включает полную разборку, дефектовку и замену изношенных деталей",
    price: "от 350 000 ₽",
    ...
    <ServiceLayout>
      ...
      <section className="py-16" style={{ backgroundColor: theme.colors.surface }}>
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12" style={{ color: theme.colors.text.primary }}>Признаки необходимости капремонта</h2>
      ...
      <section className="py-16" style={{ backgroundColor: theme.colors.surface }}>
        <div className="container mx-auto px-4">
          ...
          <Card className="max-w-md mx-auto border-0 rounded-2xl" style={{ backgroundColor: theme.colors.surface, boxShadow: theme.colors.shadows.card }}>
            <CardHeader>
              <CardTitle className="text-xl text-center" style={{ color: theme.colors.text.primary }}>Капитальный ремонт</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                <div className="flex items-center space-x-2 text-green-700">
                  ...
                  <span className="font-medium">Гарантия: 2 года</span>
                </div>
              </div>
            </CardContent>
          </Card>
...
export default MajorOverhaulService;
